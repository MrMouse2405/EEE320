...
#
# AGGRESSION PATCH:
# - Removed defensive inhibiting logic from Expanders/Scouts.
# - Movement is now "blind" and instant (fast=True default).
# - Harvesters aggressively clear neighbors before farming.
#
# ============================================================
