...
DNA_CMA_ES_BUG_RED = training_actor.DNA_CMA_ES_BUG_RED
DNA_CMA_ES_BUG_BLUE = training_actor2.DNA_CMA_ES_BUG_BLUE
...
def reset_instance_counts():
    ...
    AgrarianInstructors.SuperPlant._SuperPlant__instance_count = 0
    HuntingInstructors.Hunter._Hunter__instance_count = 0
