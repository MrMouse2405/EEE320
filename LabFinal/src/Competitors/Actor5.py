...
class DNA_CMA_ES_BUG_INFERENCE5(Creature):
    """
    ...
    def __init__(self, dna=None):
        super().__init__()
        DNA_CMA_ES_BUG_INFERENCE5.__instance_count += 1
    ...
    def instance_count(cls):
        return DNA_CMA_ES_BUG_INFERENCE5.__instance_count
    ...
    def evaluate_directions(
        ...
        for direction in Direction:
            ...
            # Enemy targeting
            if cell not in (Soil, Plant, DNA_CMA_ES_BUG_INFERENCE5, None):
                enemy_strength = 0
                if self.energy_sensor:
    ...
    def act_poison(self):
        ...
        for d in Direction:
            cell = self.type_sensor.sense(d)
            if cell not in (Soil, Plant, None, DNA_CMA_ES_BUG_INFERENCE5):
...
class InferencePropagator(Propagator):
    ...
    def make_child(self):
        ...
        return DNA_CMA_ES_BUG_INFERENCE5(parent_dna)
